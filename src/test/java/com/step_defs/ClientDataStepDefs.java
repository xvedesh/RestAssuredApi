...
public class ClientDataStepDefs {
    ...
    @Then("I send PUT request to update created {string} data and validate updated data")
    public void i_send_put_request_to_update_created_data_and_validate_updated_data(String block) {
